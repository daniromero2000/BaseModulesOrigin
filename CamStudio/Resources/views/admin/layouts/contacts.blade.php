    ...
    <div class="card-body">
      <div class="row align-items-center mb-3">
        ...
        <div class="col text-right">
          <a href="# " data-toggle="modal" data-target="#emergencycontactmodal" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
      ...
      <div class="w-100">
        <div class="table-responsive">
          ...
          @else
          <span class="text-sm">Aún no tiene contactos de emergencia</span>
          @endif
