...
class CreateCustomerEconomicActivitiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('customer_economic_activities', function (Blueprint $table) {
            ...
            $table->string('entity_legal_name');
            $table->string('entity_commercial_name')->nullable();
            ...
            $table->string('other_incomes_source')->nullable()->default('Ninguno');
            ...
            $table->integer('subsidiaries')->nullable()->default(0);
