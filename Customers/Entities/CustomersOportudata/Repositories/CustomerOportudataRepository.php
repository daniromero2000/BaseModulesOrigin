...
namespace Modules\Customers\Entities\CustomersOportudata\Repositories;

use Modules\Customers\Entities\CustomersOportudata\CustomerOportudata;
use Modules\Customers\Entities\CustomersOportudata\Repositories\Interfaces\CustomerOportudataRepositoryInterface;
...
class CustomerOportudataRepository implements CustomerOportudataRepositoryInterface
{
    protected $model;
    private $columns = [
        'id',
    ...
    public function __construct(CustomerOportudata $customer)
    {
        $this->model = $customer;
    }
    ...
    public function createCustomer(array $params): CustomerOportudata
    {
        try {
            ...
            $customer = new CustomerOportudata($data);
