...
namespace Modules\DocumentManagement\Http\Controllers\Admin\DocumentCategories;
...
class DocumentCategoryController extends Controller
{
    ...
    {
        return view('documentmanagement::admin.documentsCategory.create');
    }
    ...
    {
        return view('documentmanagement::admin.documentsCategory.show', [
