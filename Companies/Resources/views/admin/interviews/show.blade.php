                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.interviews.index') }}">Entrevistas</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">{{$interview->name}}
                                {{$interview->last_name}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<section class="content">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <a href="{{ route('admin.interviews.index') }}" class="btn btn-default btn-sm">Regresar</a>
            </div>
        </div>
    </div>
