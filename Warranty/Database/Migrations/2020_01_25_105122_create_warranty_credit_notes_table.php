...
class CreateWarrantyCreditNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warranty_credit_notes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('warranty_credit_notes');
    }
}
