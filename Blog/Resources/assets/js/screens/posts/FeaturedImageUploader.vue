...
<template>
    <modal v-if="modalShown" @close="close">
        <h2 class="font-semibold mb-5">Foto principal</h2>
        ...
        <button class="btn-sm btn-primary text-white border-0 mt-10" @click="saveImage">Guardar imagen</button>
        <button class="btn-sm btn-light text-white border-0 mt-10" @click="close">Cancelar</button>
    </modal>
</template>
