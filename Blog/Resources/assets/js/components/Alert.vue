    ...
    <div id="alert" v-show="$root.alert.type">
        <div class="dialog rounded">
            <div class="text-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" v-if="type == 'confirmation'" class="fill-red">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" v-if="type == 'success'" class="fill-green">
                    <path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM6.7 9.29L9 11.6l4.3-4.3 1.4 1.42L9 14.4l-3.7-3.7 1.4-1.42z"/>
                </svg>

                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" v-if="type == 'error'" class="fill-rd">
            ...
            <div class="flex items-center justify-center">
                <button v-if="type == 'error'" class="btn-primary text-white border-0 btn-sm" @click="close">
                    Ok
                </button>

                <button v-if="type == 'success' && !$root.alert.autoClose" class="btn-primary text-white border-0 btn-sm" @click="close">
                    Ok
                </button>


                <button v-if="type == 'confirmation'" class="btn-primary text-white border-0 btn-sm" @click="confirm">
                    Yes
                </button>
