...
<template>
    <modal v-if="modalShown" @close="close">
        ...
        <button class="btn-sm btn-primary text-white border-0 mt-10" @click="applyImage">Apply</button>
        <button class="btn-sm btn-light text-white border-0 mt-10" @click="close">Cancel</button>
    </modal>
</template>
