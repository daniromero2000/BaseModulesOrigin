...
<template>
    <modal @close="cancel">
        ...
        <div class="mt-10 flex align-center">
            <button class="btn-sm ml-1 btn-light text-white border-0 mr-auto" @click="cancel()">Cancelar</button>
            <button class="btn-sm btn-primary text-white border-0 mr-2" @click="crop()">Delimitar imagen</button>
            <button class="btn-sm btn-primary text-white border-0" @click="uploadOriginalImage()">Usar original</button>
        </div>
    </modal>
</template>
