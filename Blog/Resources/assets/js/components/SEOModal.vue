...
<template>
    <modal @close="close">
        ...
        <div class="mt-10">
            <button class="btn-sm btn-primary text-white border-0" @click="close">Guardar</button>
        </div>
    </modal>
</template>
