                                ...
                                <div id="ratingReviews" class="col-11 mx-auto col-sm-12 mt-3 px-1 " >
                                    <div id="ratingContainer" class="d-flex justify-content-center align-items-center w-100">
                                        <div id="ratingStarts" class="col-xs-12 col-md-6 text-center">
                                            <div id='promedioRating' class="rating-num">{{ $promedioRating }}<small> / 5</small></div>
                                            ...
                                            <div>
                                                <button type="button" id="moreInfo" class="btn btn-link">Ver m&aacute;s info <i class="fas fa-arrow-right"></i></button> 
                                            </div>
                                        </div>
                                        <div id="porcentByRating" class="col-xs-12 col-md-6 porcentrating toast" role="alert" aria-live="assertive" aria-atomic="true" >
                                                ...
                                                <div class="rating-desc">
                                                    @if($x5)
                                                        <div class="d-flex justify-content-between align-items-center w-100">
                                                            ...
                                                            <div class="col-xs-8 col-md-9 mb-1">
                                                                <div class="progress">
                                                                    <div class="progress-bar progress-bar-striped bg-success" role="progressbar" aria-valuenow="{{ $x5 }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $x5 }}%">
                                                    ...
                                                    @if($x4)
                                                        <div class="d-flex justify-content-between align-items-center w-100">
                                                            ...
                                                            <div class="col-xs-8 col-md-9 mb-1">
                                                                <div class="progress">
                                                                    <div class="progress-bar progress-bar bg-success" role="progressbar" aria-valuenow="{{ $x4 }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $x4 }}%">
                                                    ...
                                                    @if($x3)
                                                        <div class="d-flex justify-content-between align-items-center w-100">
                                                            ...
                                                            <div class="col-xs-8 col-md-9 mb-1">
                                                                <div class="progress">
                                                                    <div class="progress-bar progress-bar bg-info" role="progressbar" aria-valuenow="{{ $x3 }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $x3 }}%">
                                                    ...
                                                    @if($x2)
                                                        <div class="d-flex justify-content-between align-items-center w-100">
                                                            ...
                                                            <div class="col-xs-8 col-md-9 mb-1">
                                                                <div class="progress">
                                                                    <div class="progress-bar progress-bar bg-warning" role="progressbar" aria-valuenow="{{ $x2 }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $x2 }}%">
                                                    ...
                                                    @if($x1)
                                                        <div class="d-flex justify-content-between align-items-center w-100">
                                                            ...
                                                            <div class="col-xs-8 col-md-9 mb-1">
                                                                <div class="progress">
                                                                    <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="{{ $x1 }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $x1 }}%">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row" id="rating-ability-wrapper">
                                                    ...
                                                    <label class="col-md-12  control-label d-flex justify-content-center" for="rating">
                                                        <span class="field-label-header">Que tal te parece este producto</span><br>
                                                        <span class="field-label-info"></span>
                                                        <input type="hidden" id="selected_rating" name="selected_rating" value="" required="required">
                                                        <input type="hidden" id="product_id" name="product_id" value="{{$product->id}}" required="required">
                                                    </label>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" id="createProductReview" disabled class="btn button-reset" data-dismiss="modal">Enviar
