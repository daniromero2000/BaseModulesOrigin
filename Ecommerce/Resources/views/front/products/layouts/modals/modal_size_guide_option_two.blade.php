    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="w-100 p-3">
                    <h4 class="my-3"> ENCUENTRA LA TALLA </h4>
                    <p>
                        <b>1.</b> Coloca el pie en una superficie plana sobre una hoja de papel blanca con el talón
                        contra la
                        pared:
                    </p>
                    <div class="mb-5" style=" max-width: 300px; margin: auto; ">
                        <img class="img-fluid" src="{{ asset('img/paso1.png')}}" alt="paso 1">
                    </div>
                    <p>
                    ...
                    <div class="mb-5" style=" max-width: 300px; margin: auto; ">
                        <img class="img-fluid" src="{{ asset('img/paso2.png')}}" alt="paso 2">
                    </div>
                    <p>
                    ...
                    <div class="mb-5" style=" max-width: 300px; margin: auto; ">
                        <img class="img-fluid" src="{{ asset('img/paso3.png')}}" alt="paso 3">
                    </div>
                </div>
            </div>
