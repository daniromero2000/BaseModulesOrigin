...
use Modules\Ecommerce\Entities\PaymentMethods\PayU\lib\PayU\exceptions\ConnectionException as ExceptionsConnectionException;
...
class HttpClientUtil
{
    ...
    static function sendRequest($request, PayUHttpRequestInfo $payUHttpRequestInfo)
    {
        ...
        if ($curlResponse === false && $httpStatus === 0) {
            throw new ExceptionsConnectionException(PayUErrorCodes::CONNECTION_EXCEPTION, 'the url [' . $payUHttpRequestInfo->getUrl() . '] did not respond');
        }
