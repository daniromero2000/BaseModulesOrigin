...
class CreateRefundsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('refunds', function (Blueprint $table) {
            ...
            $table->decimal('adjustment_refund', 12, 2)->default(0)->nullable();
            $table->decimal('base_adjustment_refund', 12, 2)->default(0)->nullable();

            $table->decimal('adjustment_fee', 12, 2)->default(0)->nullable();
            $table->decimal('base_adjustment_fee', 12, 2)->default(0)->nullable();
