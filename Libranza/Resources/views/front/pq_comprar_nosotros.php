...
<head>
    ...
    <title>Libranza Fácil - ¿Por qué comprar con nosotros?</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <div class="row row-reset">
        <div class="col-12 col-md-12">
            <div style="padding: 10px 0px 20px 0px;" class="row text-center row-reset">
                <div class="col-12 col-md-12">
                    <h4 class="TitleLegal">¿Por qué comprar con nosotros?</h4>
                </div>
            </div>
        </div>
        <div class="row row-reset" style="width: 80%; margin:auto">
            <h4 style="color: #0063AB">49 años respaldan tu compra</h4>
        </div>
        <div class="row row-reset" style="width: 80%; margin:auto">
        ...
        <div class="row row-reset" style="width: 80%; margin:auto">
            <h4 style="color: #0063AB">Por economía</h4>
        </div>
        <div class="row row-reset" style="width: 80%; margin:auto">
        ...
        <div class="row row-reset" style="width: 80%; margin:auto">
            <h4 style="color: #0063AB">Por Comodidad</h4>
        </div>
        <div class="row row-reset" style="width: 80%; margin:auto">
        ...
        <div class="row row-reset" style="width: 80%; margin:auto">
            <h4 style="color: #0063AB">Por seguridad</h4>
        </div>
        <div class="row row-reset" style="width: 80%; margin:auto">
        ...
        <div class="row row-reset" style="width: 80%; margin:auto">
            <h4 style="color: #0063AB">Facilidad de pago</h4>
        </div>
        <div class="row row-reset" style="width: 80%; margin:auto">
        ...
        <div class="row row-reset" style="width: 80%; margin:auto">
            <h4 style="color: #0063AB">Velocidad en las entregas</h4>
        </div>
        <div class="row row-reset" style="width: 80%; margin:auto">
